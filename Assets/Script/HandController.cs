    ...
    void Update()
    {
        ...
        if (selectedRightSpaceObject != null)
        {
            ...
            if (simulaGestureRilasciaDestra && !simulaGestureAfferraDestra)
            {
                ...
                Messenger<bool>.Broadcast(GameEvents.GESTURE_MENU_RIGHT, false);
                this.rightHandSelector.mode=selectorMode.CanSelect;
                simulaGestureRilasciaDestra = false;
                selectedRightSpaceObject.rayNumber = 0;
                selectedRightSpaceObject.timerContained = 0;
                selectedRightSpaceObject.stop = false;
                selectedRightSpaceObject.ris = null;
                this.selectedRightSpaceObject = null;
                this.selectedRightHandObject = null;

                //     rightHandSelector.resetSelected();
        ...
        if (selectedLeftSpaceObject != null)
        {
            ...
            if (simulaGestureRilasciaSinistra && !simulaGestureAfferraSinistra)
            {
                ...
                Messenger<bool>.Broadcast(GameEvents.GESTURE_MENU_LEFT, false);

                this.simulaGestureRilasciaSinistra = false;
                this.selectedLeftSpaceObject = null;
                this.selectedLeftHandObject = null;
                leftHandSelector.resetSelected();
                // selectedRightSpaceObject=null;
            }
